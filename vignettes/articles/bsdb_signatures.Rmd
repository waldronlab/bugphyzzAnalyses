...
draw(
    l_ht_down$BSDB_BS,
    column_title = "Union of BSDB sigs by body site - decreased"
)
```
...
draw(
    l_ht_down$TMS_BSDB,
    column_title = "Union of BSDB and TMS signatures - decreased"
)
```
...
draw(
    l_ht_up$TMS_BSDB_BS,
    column_title = "Union of BSDB and TMS sigs by body site - increased"
)
```
...
draw(
    l_ht_down$TMS_BSD,
    column_title = "Intersection of BSDB and TMS sigs - decreased"
)
```
...
draw(
    ...
    column_title = "Intersection of BSDB and TMS sigs by body site - increased"
)
```
