...
draw(l_ht_up$BSDB, column_title = "Background: union of BSDB signatures - Direction: increased")
```

down:

```{r, fig.height=10, fig.width=15}
draw(l_ht_down$BSDB, column_title = "Background: union of BSDB signatures - direction: decreased")
```
...
draw(l_ht_up$BSDB_BS, column_title = "Background: union of BSDB sigs by body site - Direction: increased" )
```

down:

```{r, fig.height=8, fig.width=12}
draw(l_ht_down$BSDB_BS, column_title = "Union of BSDB sigs by body site - decreased")
```
...
draw(l_ht_up$TMS_BSDB, column_title = "Background: union of BSDB and TMS signatures - Direction: increased")
```

down:

```{r, fig.height=9, fig.width=14}
draw(l_ht_down$TMS_BSDB, column_title = "Union of BSDB and TMS signatures - decreased")
```
...
draw(l_ht_up$TMS_BSDB_BS, column_title = "Union of BSDB and TMS sigs by body site - increased")
```

down:

```{r, fig.height=8, fig.width=12}
draw(l_ht_down$TMS_BSDB_BS, column_title = "Background: union of BSDB and TMS sigs by body site - Direction: decreased")
```
...
draw(l_ht_up$TMS_BSDB_intersect, column_title = "Background: intersection of BSDB and TMS sigs - Direction: increased")
```
...
```{r, eval=FALSE}
draw(l_ht_down$TMS_BSD, column_title = "Intersection of BSDB and TMS sigs - decreased")
```
...
```{r, eval=FALSE}
draw(l_ht_up$TMS_BSDB_BS_interesct, column_title = "Intersection of BSDB and TMS sigs by body site - increased")
```

down:

```{r}
draw(l_ht_down$TMS_BSDB_BS_intersect, column_title = "Background: intersection of BSDB adn TMS sigs by body site - Direction: decreased")
...
draw(l_ht_up$TMS_1BSDB, column_title = "Background: union of TMS and one target BSDB signature - Direction: increased")
```

down:

```{r, fig.height=9, fig.width=10}
draw(l_ht_down$TMS_1BSDB, column_title = "Background: union of TMS and one target BSDB signature - Direction: decreased")
```
