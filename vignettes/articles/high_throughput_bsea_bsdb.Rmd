...
mat_condition <- enrichDF |> 
    ...
    left_join(summary_category, by = c('Category' = 'category')) |> 
...
mat_bodysite <- enrichDF |> 
    ...
    left_join(summary_bodysite, by = 'body_site') |> 
...
colnames_order_category <- 
colnames_order_bodysite
...
ht1 <- Heatmap(
    ...
    row_names_max_width = max_text_width(
        rownames(summary_condition_mat),
        gp = gpar(fontsize = 12)
    ),
