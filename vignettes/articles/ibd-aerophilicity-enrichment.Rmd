...
Completeness is too low (about 2%). Let's try to improve the completeness
of annotations with ASR/Inheritance.
...
```{r}
prior_info <- taxa_data |> 
    left_join(aer_plus_species, by = c('taxon_name' = 'NCBI_ID')) |> 
