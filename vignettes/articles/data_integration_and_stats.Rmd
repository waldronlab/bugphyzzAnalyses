...
>In the plot above, so many are usually becose of the penalty of the
...
## Evidence and frequency (leaving strins out)
...
```{r}
exclude_all_fname <- system.file(file.path('extdata', 'proc_exclude_all_07122023.txt'), package = 'taxPPro', mustWork = TRUE)
...
### Completeness table before propgation
