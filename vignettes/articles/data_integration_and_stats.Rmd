...
This reflects the histogram above.
...
#> TODO We should have a lot more of usually rather than always, I'll write
#> a temporary fix in the bugphyzz import code, but this should be fix in the
#> propagation workflow. I applied this temporary fix but it should be addressed
#> in the propagation workflow.
...
bp |> 
  ...
  scale_y_continuous(limits = c(0, 1.5e6), labels = scales::comma) +
  scale_y_cut(breaks = c(5000, 100000)) +
  theme_bw() +
  theme(
...
This plot could be used for the supplementary figure:

```{r supplementaru fig, fig.width=19, fig.height=6}
